...
class ChatSingleLayout extends StatelessWidget {
  ...
  /// 1普通成员, 2群组，3管理员
  Widget _buildTagView(int roleLevel) {
    if (roleLevel == 2 || roleLevel == 3) {
      return Container(
        padding: EdgeInsets.symmetric(horizontal: 6.w, vertical: 3.h),
        margin: EdgeInsets.only(left: 4.w),
        decoration: BoxDecoration(
          color: roleLevel == 2 ? Color(0xFFF2A813) : Color(0xFF1A8CFF),
        ...
        child: Text(
          ...
          style: TextStyle(
              height: 0.9,
              color: roleLevel == 2 ? Color(0xFFffffff) : Color(0xFFffffff),
              fontSize: 8.sp),
          strutStyle: StrutStyle(forceStrutHeight: true, fontSize: 8.sp),
        ),
      );
    } else {
      return Container();
