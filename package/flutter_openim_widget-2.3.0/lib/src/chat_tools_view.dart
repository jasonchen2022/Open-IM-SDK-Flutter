          ...
          children: [
              ...
              children: [
                _toolsOption(ToolsItem(
                  ...
                  image: _buildBtn(
                    ...
                    onTap: () =>
                        PermissionUtil.storage(() => widget.onTapAlbum?.call()),
                  ),
                )),
                _verticalSpacing,
                _toolsOption(ToolsItem(
              ...
              children: [
                _toolsOption(ToolsItem(
                  ...
                  image: _buildBtn(
                    ...
                    onTap: () =>
                        PermissionUtil.camera(() => widget.onTapCamera?.call()),
                  ),
                )),
                _verticalSpacing,
                _toolsOption(ToolsItem(
            ...
            Column(
              children: [
                ...
                // )),
                _toolsOption(ToolsItem(
                  label: UILocalizations.dice,
                  style: toolsTextStyle,
                  image: _buildBtn(
                    icon: widget.diceIcon ?? ImageUtil.toolsVoiceInput(),
            ...
            Column(children: [
              _toolsOption(ToolsItem(
                  label: UILocalizations.redPacket,
                  style: toolsTextStyle,
                  image: _buildBtn(
                    icon: widget.redPacketIcon ?? ImageUtil.toolsAlbum(),
