...
import 'package:flutter_openim_widget/model/red_packet.dart';
...
class _ChatItemViewState extends State<ChatItemView> {
    ...
    return FocusDetector(
      child: Container(
        padding: widget.padding ??
            EdgeInsets.fromLTRB(
              widget.multiSelMode && !_isHintMsg ? 0 : 14.w,
              0,
              14.w,
              _isHintMsg ? 5.h : 15.h,
            ),
    ...
    try {
      ...
      switch (widget.message.contentType) {
        ...
        case MessageType.custom:
          {
            var data = widget.message.customElem!.data;
            var map = json.decode(data!);
            var customType = map['customType'];
            if (customType == 889) {
              String text = map.toString();
              RedPacket redPacket = RedPacket.fromJson(map['data']);
              if (widget.message.sendID == OpenIM.iMManager.uid) {
                text = '你领取了${redPacket.userName ?? "未知"}的红包';
              } else {
                text =
                    '${widget.message.senderNickname}领取了${redPacket.userId == OpenIM.iMManager.uid ? '你' : (redPacket.userName ?? '未知')}的红包';
              }
              widget.enabledReadStatus = false;
              child = _buildCommonItemView(
                isBubbleBg: false,
                isHintMsg: true,
                child: Row(
                  ...
                  children: [
                    Image.asset(
                      'assets/images/red_packet_mini.png',
                      width: 10.w,
                      height: 10.w,
                    ),
                    SizedBox(
  ...
  List<MenuInfo> _menusItem() => [
        MenuInfo(
          icon: SvgPicture.asset('assets/images/menu_copy.svg',
              width: 18.w, height: 18.w, color: Color(0xFF202331)),
        ...
        MenuInfo(
          icon: SvgPicture.asset('assets/images/menu_del.svg',
              width: 18.w, height: 18.w, color: Color(0xFF202331)),
        ...
        // 屏蔽转发
        // MenuInfo(
        //   icon: SvgPicture.asset('assets/images/menu_zhuanfa.svg',
        //       width: 18.w, height: 18.w, color: Color(0xFF202331)),
        ...
        // ),
        MenuInfo(
          icon: SvgPicture.asset('assets/images/menu_huifu.svg',
              width: 18.w, height: 18.w, color: Color(0xFF202331)),
        ...
        MenuInfo(
            icon: SvgPicture.asset('assets/images/menu_chehui.svg',
                width: 18.w, height: 18.w, color: Color(0xFF202331)),
        ...
        MenuInfo(
          icon: SvgPicture.asset('assets/images/menu_duoxuan.svg',
              width: 18.w, height: 18.w, color: Color(0xFF202331)),
        ...
        // 置顶
        // MenuInfo(
        //   icon: SvgPicture.asset('assets/images/menu_top.svg',
        //       width: 18.w, height: 18.w, color: Color(0xFF202331)),
        //   text: UILocalizations.top,
        //   enabled: widget.enabledTopMsg,
        //   textStyle: menuTextStyle,
        //   onTap: widget.onTapTopMsg,
        // ),
        // MenuInfo(
        ...
        // ),
        MenuInfo(
          icon: SvgPicture.asset('assets/images/menu_addbiaoqing.svg',
              width: 18.w, height: 18.w, color: Color(0xFF202331)),
